...
This repository is an independent Doramagic AI context resource pack for openai/openai-agents-python.
...
Do not use this repository as the upstream project's support tracker. If the bug is in openai/openai-agents-python itself, report it to https://github.com/openai/openai-agents-python/issues first and link the upstream issue here only when it changes this pack.
