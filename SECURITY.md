...
This repository is an independent AI context resource pack for openai/openai-agents-python. It is not Openai Agents Python's official security contact.
...
Upstream product vulnerabilities should be reported to openai/openai-agents-python's own security policy. Link the upstream advisory here only when this pack needs a mitigation or warning.
